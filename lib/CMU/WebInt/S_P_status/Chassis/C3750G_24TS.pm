...
package CMU::WebInt::S_P_status::Chassis::C3750G_24TS;
use strict;
use warnings;
...
# require superclass
require CMU::WebInt::S_P_status::Chassis::C3750;


use vars qw (@ISA @EXPORT @EXPORT_OK);

require Exporter;
@ISA = qw(Exporter CMU::WebInt::S_P_status::Chassis::C3750);
...
sub init {
  ...
  $self->{'vars'}{'chassis_type'} = "C3750G-24TS";
